...
import {ActiveBlockedPipe} from "./employee/ActivedBlockedPipe";

@NgModule({
    declarations: [InsertUpdateEmpComponent, ConfirmDeleteEmpComponent, MyIfDirective, EmployeeComponent, ActiveBlockedPipe],
    imports: [
        CommonModule,
        SharedModule,
        NgbModule,
        ...
        RouterModule.forChild([
            {path: '', pathMatch: 'full', redirectTo: 'emp-mng'},
            {
                ...
                data: {breadcrumbs: ['EmployeeManagement', '']},
                children: [
                    {
                        path: 'search',
                        component: Employee
